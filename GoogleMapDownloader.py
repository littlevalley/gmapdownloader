...
class GoogleMapDownloader:
    ...
    def generateImage(self, **kwargs):
        ...
        tile_width = kwargs.get('tile_width', 25)
        tile_height = kwargs.get('tile_height', 7)
		...
		print(url)
		response = self.s.get(url,proxies={ "http": "http://127.0.0.1:8118", "https": "http://127.0.0.1:8118", })
...
def main():
    ...
    gmd = GoogleMapDownloader(29.65,91.11, 18)
